...
class Agent(Base):
    ...
    lin_telemetry: Mapped[dict] = mapped_column(JSON, default=dict)    # Linux Sentinel services/telemetry (agent-reported)
    silent_alerted: Mapped[bool] = mapped_column(Boolean, default=False)  # liveness: AGENT_SILENT already emitted for the current gap
