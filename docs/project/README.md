...
> **Documentation set:** v1.11.0 · **Last updated:** 2026-08-07 · **Status:** Current
...
2. **Agent build versions** — each agent embeds its own `VERSION` string (Linux `0.4.4`, Windows
   `0.5.1-win`). Agents are shipped as **Ed25519-signed** builds; the control-plane manifest advertises
